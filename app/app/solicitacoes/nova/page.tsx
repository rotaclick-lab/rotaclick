    ...
    <div className="mx-auto max-w-2xl">
      <Card className="space-y-4">
        <div className="space-y-1">
          ...
          <p className="text-sm text-slate-600">Preencha para receber propostas.</p>
        </div>
        ...
        <form action={criarSolicitacao} className="space-y-4">
          <div className="grid gap-4 sm:grid-cols-3">
            <div className="space-y-1 sm:col-span-1">
              ...
              <Input id="origin_zip" name="origin_zip" required placeholder="01000-000" />
            </div>
            <div className="space-y-1 sm:col-span-1">
          ...
          <div className="grid gap-4 sm:grid-cols-3">
            <div className="space-y-1 sm:col-span-1">
              ...
              <Input id="destination_zip" name="destination_zip" required placeholder="13000-000" />
            </div>
            <div className="space-y-1 sm:col-span-1">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <div className="space-y-1">
              ...
              <Input id="invoice_value" name="invoice_value" inputMode="decimal" placeholder="15000,00" />
            </div>
            <div className="space-y-1">
          ...
          <div className="space-y-1">
            ...
            <Input id="cargo_description" name="cargo_description" placeholder="Opcional" />
          </div>
